<h1>Sample Code for Invoices App</h1>

The application has the following requirements:

1. Login screen for staff to login.
2. Registration screen to registration fruit category (Master data).
   • Example: “apple”, “orange”, “pear”
3. Registration screen to registration fruit item (Master data).
   • Example: Under category “apple” – “Vietnam small apple”, “Vietnam big apple”,
   “China small apple” …
...
• Example:
Customer Brad Pitt
No Category Fruit Unit Price Quantity Amount
1 Apple Vietnam small apple Pcs 2 10 20
2 Apple China big apple pack 8 2 16
3 Orange Vietnam big orange Kg 5 3 15
Total 51
• Able to Create, Edit and Delete Invoices
 <h2>Tech used</h2>
 <p>Laravel 8 Framework</p>
 <p>MySql DB</p>
